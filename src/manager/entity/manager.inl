...
template<typename T>
T &entity::instance::add(id entity)
{
	// Get type
...
template<typename T>
T &entity::instance::get(id entity) const
{
...
template<typename T>
bool entity::instance::check(id entity) const
{
...
template<typename T>
typename std::enable_if<!entity::is_std_function<T>::value>::type entity::instance::each(T iterator)
{
...
template<typename T>
void entity::instance::each(std::function<void(T)> iterator)
{
...
template<typename T>
void entity::instance::each(std::function<void(T, id)> iterator)
{
	// Read only iterate over copies of all properties
	auto &p = get_property<T>();
	std::lock_guard<std::recursive_mutex> lock(p.m_values_mutex);
...
template<typename T>
size_t entity::instance::size() const
{
...
template<typename T>
entity::id entity::instance::resolve(size_t index) const
{
...
template<typename T>
entity::property<T> &entity::instance::get_property() const
{
